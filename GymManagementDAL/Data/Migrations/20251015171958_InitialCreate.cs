        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Member_ValidEmail", "Email LIKE '_%@_%._%'");
                    table.CheckConstraint("CK_Member_ValidPhone", "Phone Like '01_________' and Phone Not Like '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Plan_DurationDaysRange", "[DurationDays] BETWEEN 1 AND 365");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Trainer_ValidEmail", "Email LIKE '_%@_%._%'");
                    table.CheckConstraint("CK_Trainer_ValidPhone", "Phone Like '01_________' and Phone Not Like '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Session_CheckCapacity", "[Capacity] BETWEEN 1 AND 25");
                    table.CheckConstraint("CK_Session_EndDateAfterStartDate", "EndDate > StartDate");
                    table.ForeignKey(
